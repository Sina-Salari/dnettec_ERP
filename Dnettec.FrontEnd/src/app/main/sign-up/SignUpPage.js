...
function SignUpPage() {
  ...
  const schema = yup.object().shape({
    displayName: yup.string().required(t("ENTER_DISPLAY_NAME")),
    email: yup
      .string()
      .email(t("ENTER_VALID_EMAIL"))
      .required(t("ENTER_AN_EMAIL")),
    password: yup
      .string()
    ...
    acceptTermsConditions: yup.boolean().oneOf([true], t("ACCEPT_TOS")),
  });
