        ...
        <div className="flex flex-col">
          ...
          <div className="flex-auto grid grid-cols-4 gap-16 mt-24">
            <div className="col-span-2 flex flex-col items-center justify-center py-32 px-4 rounded-2xl bg-indigo-50 text-indigo-800">
              ...
              <Typography className="mt-4 text-sm sm:text-lg font-medium">{t('NEW_ISSUES')} </Typography>
            </div>
            <div className="col-span-2 flex flex-col items-center justify-center py-32 px-4 rounded-2xl bg-green-50 text-green-800">
              ...
              <Typography className="mt-4 text-sm sm:text-lg font-medium">{t('CLOSED')} </Typography>
            </div>
            <Box
              sx={{
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">{t('FIXED')}</Typography>
            </Box>
            <Box
              sx={{
                backgroundColor: (_theme) =>
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">{t('WONT_FIX')}</Typography>
            </Box>
            <Box
              sx={{
                backgroundColor: (_theme) =>
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">{t('RE_OPENED')} </Typography>
            </Box>
            <Box
              sx={{
                backgroundColor: (_theme) =>
            ...
            >
              ...
              <Typography className="mt-4 text-sm font-medium text-center">{t('NEED_TRIAGE')} </Typography>
            </Box>
          </div>
        </div>
      </div>
